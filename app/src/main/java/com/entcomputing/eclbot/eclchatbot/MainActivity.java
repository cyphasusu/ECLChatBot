package com.entcomputing.eclbot.eclchatbot;
        ...
        Thread thread = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    service.setUsernameAndPassword("07b2468d-04f2-491c-ac41-2bd3d6c811b4", "LsoVkexYDADL");

                    InputData input = new InputData.Builder(inputmessage).build();
                    MessageOptions options = new MessageOptions.Builder("6c2cdb93-2fcf-4413-a528-f39e017a9dd2").input(input).context(context).build();
